...
{
    public partial class InputDataSetoranCRMForm : Form
    {
        public InputDataSetoranCRMForm()
        {
            InitializeComponent();
        }
            ...
            if (of.ShowDialog() == DialogResult.OK)
            {
                ...
                foreach (DataRow row in dt.Rows)
                {
                    dataExcel.Add(new TabelTarikanSetoranCRM()
                    {
                        ...
                        nominal = Int64.Parse(row[COLINDEX_NOMINALSetoran].ToString()),
                        jenis = "Setoran"
                    });
                }
